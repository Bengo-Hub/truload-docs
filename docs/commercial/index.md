...
- :material-truck: **[Tare Management](tare-management.md)**
    ...
    Preset, measured, and stored tare weights

- :material-ticket: **[Weight Tickets](weight-tickets.md)**

    Ticket format, printing, quality deductions

- :material-chart-bar: **[Reports](reports.md)**

    All available report types and filters

- :material-cog: **[Setup & Configuration](setup.md)**

    Tolerances, cargo types, origin/destination, station config
