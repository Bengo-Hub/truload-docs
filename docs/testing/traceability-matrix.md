...
| Weighing capture | `truload-backend/Controllers/WeighingController.cs`, `TruConnect/src/` | [Weighing](../enforcement/weighing.md) · [Architecture](../technical/architecture.md) | Compliance end-to-end (14-step) |
